...
public class CameraLollipopFragment extends Fragment implements View.OnClickListener, FragmentCompat.OnRequestPermissionsResultCallback, CameraFragment {
     ...
     */
    private static final String TAG = "CameraLollipopFragment";
...
//                }
     ...
     */
    @Override
    public void takePicture(OnCaptureCompleted callback) {
        synchronized (mCameraStateLock) {
            mOnCaptureCompletedAction = callback;
    ...
    private void captureStillPictureLocked() {
        try {
            ...
            // fixme: Even though it works, it looks really hacky and I do not understand why it works. Best guess, it has something to do with natural orientation.
            if(rotation == Surface.ROTATION_90 || rotation == Surface.ROTATION_270)
                rotation = rotation == Surface.ROTATION_90 ? Surface.ROTATION_270 : Surface.ROTATION_90;
            ...
            if (success) {
                ...
                /*mimeTypes*/null, new MediaScannerConnection.MediaScannerConnectionClient() {
                    ...
                    public void onScanCompleted(String path, Uri uri) {
                        ...
                        if(mOnCaptureCompletedAction != null)
                            mOnCaptureCompletedAction.onCaptureComplete(path, uri);
                        mOnCaptureCompletedAction = null;
                    }
                });
            }
        }
    ...
    private static Size chooseOptimalSize(Size[] choices, int width, int height, Size aspectRatio) {
        ...
        for (Size option : choices) {
            ...
            else if(option.getHeight() >= Constants.IMAGE_OPTIMAL_HEIGHT && option.getWidth() >= Constants.IMAGE_OPTIMAL_WIDTH){
    ...
    private void handleCompletionLocked(int requestId, ImageSaver.ImageSaverBuilder builder,
        ...
        if (saver != null) {
            ...
            //getActivity().runOnUiThread(saver);
