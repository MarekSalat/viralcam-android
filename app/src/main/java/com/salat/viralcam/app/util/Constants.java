...
public class Constants {
    ...
    public static final boolean ALWAYS_SHOW_WHATS_NEW = BUILD_TYPE == BuildType.Debug;
    public static final boolean ALWAYS_SHOW_INTRODUCTION = BUILD_TYPE == BuildType.Debug;
